package com.rsw.mvvmdemo.activity.collect.collect.adapter;
...
import com.rsw.mvvmdemo.databinding.HomeItemBinding;
...
public class CollectAdapter extends BaseAdapter<HomeBean> {
    ...
    public void onBindMyViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        binding.imageZan.setImageResource(R.drawable.card_zan_35);
