 ...
 * @time 2020/9/15  15:56
 * @describe
 */
public class ProviderNominateAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<YinshiBean.ListBean> mDatas;

    public ProviderNominateAdapter(Context context, List<YinshiBean.ListBean> mDatas) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (null == entity.getImage() || !entity.getImage().contains("@rsw@")) {
            ...
            Glide.with(context).load(imgUrl).transition(DrawableTransitionOptions.withCrossFade()).placeholder(R.drawable.default_img).error(R.drawable.default_img).into(binding.ivImage);
    ...
    private ProviderDailyAdapter.OnItemClickLitener mOnItemClickLitener;

    public void setOnItemClickLitener(ProviderDailyAdapter.OnItemClickLitener mOnItemClickLitener) {
